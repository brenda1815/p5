    ...
    <div class="col-lg-4 col-md-6 col-sm-8 ml-auto mr-auto">
      <form class="form" method="POST" action="<?php echo e(route('login')); ?>">
        ...
        <div class="card card-login card-hidden mb-3">
          ...
          <div class="card-body">
            <p class="card-description text-center"><?php echo e(__('Bienvenido usuario ')); ?>  </p>
           
              <!--username-->
              <div class="bmd-form-group<?php echo e($errors->has('username') ? ' has-danger' : ''); ?>">
                <div class="input-group">
                  ...
                  <input type="username" name="username" class="form-control" placeholder="<?php echo e(__('username or email...')); ?>" value="<?php echo e(old('email', null)); ?>" required autocomplete="email">
                </div>
...
<?php echo $__env->make('layouts.main', ['class' => 'off-canvas-sidebar', 'activePage' => 'login', 'title' => __('Control de inventario')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\proyectou5\resources\views/auth/login.blade.php ENDPATH**/ ?>